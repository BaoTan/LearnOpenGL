...
int main()
{
    ...
    // ------------------------------------
    std::string texture_vs = FileSystem::getPath("src/1.getting_started/4.5.textures_exercise3/4.4.texture.vs");
    std::string texture_fs = FileSystem::getPath("src/1.getting_started/4.5.textures_exercise3/4.4.texture.fs");
